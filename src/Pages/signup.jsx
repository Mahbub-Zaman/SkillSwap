...
const Signup = () => {
  ...
  const handleRegister = async (e) => {
    ...
    if (passwordError) return; // prevent submission if password invalid
      ...
      <form onSubmit={handleRegister} className="bg-white shadow-md rounded-lg p-8 w-96">
        ...
        <div className="mb-4 flex items-center gap-2 mt-3">
          ...
          <label htmlFor="terms" className="text-gray-700 text-sm">
            Accept our <span className="text-purple-600 font-medium">terms and conditions</span>
          </label>
        </div>
        ...
        <button
          ...
          className={`w-full py-2 rounded-md font-semibold text-white transition-colors duration-300 ${
            loading || passwordError ? "bg-gray-400" : "bg-purple-500 hover:bg-purple-600"
          }`}
        >
